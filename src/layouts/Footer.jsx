    ...
    <footer className="bg-[#2B2A40] text-white px-6 py-10">
      <div className="container mx-auto px-5">
        ...
        <div className="grid md:grid-cols-4 gap-10 text-sm">
          ...
          {/* Empty grid columns for future use or design symmetry */}
          <div></div>
          <div></div>
        </div>

        {/* Footer Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-white mt-6  text-gray-500 text-sm">
          <p>
            {COPY_RIGHT}
